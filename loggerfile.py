...
if len( sys.argv ) < 2:
	...
	print( file=sys.stderr )
	print( 'If signal is unspecified,', me, 'will start a new instance and log STDIN to the specified file.', file=sys.stderr )
	print( 'If a signal is specified,', me, 'will locate the process currently logging to the specified file', file=sys.stderr )
